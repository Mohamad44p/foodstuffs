      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Case Studies", "Thought Leadership", "News", "Resources"].map(
                (item) => (
                  <li key={item}>
          ...
          <div className="md:col-span-3 lg:col-span-1">
            ...
            <address className="mt-6 space-y-1 not-italic">
              <p className="flex items-center gap-x-3">
                <Globe size={20} aria-hidden="true" /> Hebron, Palestine
              </p>
              <p className="flex items-center gap-x-3">
        ...
        <div className="border-t border-gray-300 pt-8 flex flex-col items-center">
          ...
          <div className="flex justify-between items-center w-full flex-wrap gap-4">
            <div className="flex space-x-4">
              {["Privacy Policy", "Terms of Use", "Trust"].map((item) => (
                <Link
                  key={item}
                  href="#"
            ...
            <p className="text-sm">
              &copy; {new Date().getFullYear()} Adeeb Al-Junaidi. All rights
              reserved.
            </p>
            <div className="flex space-x-4">
